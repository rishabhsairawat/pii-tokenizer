...
For each JSON column you want to tokenize, you need to create a corresponding "_token" column:
...
4. Falls back to the original column if the token column is empty
